...
while(t<614517){
  if(data$Quarter[t]==4 && data$Quarter[t-1]==3 && data$Quarter[t-2]==3){
    ...
    if(grepl("Defensive rebound", data$HomePlay[t], fixed=TRUE)){
    ...
    if(grepl("Defensive rebound", data$AwayPlay[t], fixed=TRUE)){
